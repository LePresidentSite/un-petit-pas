...
const CACHE_VERSION = "un-petit-pas-v56";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=20260615-pro-limits-v2",
  "./config.js",
  "./account.js?v=20260615-pro-limits-v2",
  "./data.js?v=20260615-petits-pas-v2",
  "./db.js?v=20260615-cloud-sync-v2",
  "./app.js?v=20260615-pro-limits-v2",
