  ...
  const referenceZones = [
    {
      ...
      tasks: [
        ...
        referenceTask("entry_balcony_ref_003", "Ramasser ce qui traîne", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_004", "Ranger les sacs et accessoires", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_005", "Secouer le tapis d'entrée", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_006", "Passer le balai", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_007", "Passer l'aspirateur", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_008", "Passer la vadrouille", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_009", "Essuyer la porte d'entrée", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_010", "Nettoyer les poignées de porte", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_011", "Essuyer les interrupteurs", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_012", "Nettoyer le miroir", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_013", "Épousseter les surfaces", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_014", "Nettoyer les traces sur les murs", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_015", "Essuyer la table du balcon", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_016", "Nettoyer les chaises", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_017", "Essuyer la rampe", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_018", "Nettoyer la porte-patio", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_019", "Nettoyer la vitre de la porte-patio", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_020", "Enlever les feuilles et débris", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_021", "Arroser les plantes", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_022", "Secouer les coussins extérieurs", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_023", "Ranger les accessoires du balcon", "Entrée & balcon"),
        referenceTask("entry_balcony_ref_024", "Faire un petit tri", "Entrée & balcon")
      ]
    },
    {
      id: "kitchen-dining",
      ...
      tasks: [
        ...
        referenceTask("kitchen_dining_ref_003", "Vider le lave-vaisselle", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_004", "Remplir le lave-vaisselle", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_005", "Nettoyer l'évier", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_006", "Essuyer les robinets", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_007", "Essuyer les comptoirs", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_008", "Nettoyer la table", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_009", "Essuyer les chaises", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_010", "Essuyer le dessus de la cuisinière", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_011", "Nettoyer le micro-ondes", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_012", "Essuyer l'extérieur du frigo", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_013", "Faire un petit ménage du frigo", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_014", "Jeter les aliments passés date", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_015", "Essuyer les portes d'armoires", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_016", "Nettoyer les poignées d'armoires", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_017", "Essuyer les petits électroménagers", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_018", "Vider la poubelle", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_019", "Sortir le recyclage", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_020", "Épousseter les meubles", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_021", "Passer le balai", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_022", "Passer l'aspirateur", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_023", "Passer la vadrouille", "Cuisine & salle à manger"),
        referenceTask("kitchen_dining_ref_024", "Nettoyer une petite section à fond", "Cuisine & salle à manger")
      ]
    },
    {
      id: "living",
      ...
      tasks: [
        ...
        referenceTask("living_ref_003", "Plier les couvertures", "Salon"),
        referenceTask("living_ref_004", "Ranger la table de salon", "Salon"),
        referenceTask("living_ref_005", "Nettoyer la table de salon", "Salon"),
        referenceTask("living_ref_006", "Épousseter les meubles", "Salon"),
        referenceTask("living_ref_007", "Épousseter les décorations", "Salon"),
        referenceTask("living_ref_008", "Essuyer les interrupteurs", "Salon"),
        referenceTask("living_ref_009", "Nettoyer les poignées de porte", "Salon"),
        referenceTask("living_ref_010", "Nettoyer les traces sur les murs", "Salon"),
        referenceTask("living_ref_011", "Nettoyer le miroir", "Salon"),
        referenceTask("living_ref_012", "Ranger les télécommandes", "Salon"),
        referenceTask("living_ref_013", "Vider la poubelle", "Salon"),
        referenceTask("living_ref_014", "Passer l'aspirateur sur le divan", "Salon"),
        referenceTask("living_ref_015", "Passer l'aspirateur", "Salon"),
        referenceTask("living_ref_016", "Passer le balai", "Salon"),
        referenceTask("living_ref_017", "Passer la vadrouille", "Salon"),
        referenceTask("living_ref_018", "Ranger une petite section", "Salon"),
        referenceTask("living_ref_019", "Faire un petit tri", "Salon")
      ]
    },
    {
      id: "bathroom-laundry",
      number: 4,
      name: "Salle de bain & salle de lavage",
      short: "Z4",
      ...
      tasks: [
        ...
        referenceTask("bathroom_laundry_ref_003", "Essuyer les robinets", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_004", "Nettoyer le miroir", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_005", "Essuyer le comptoir", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_006", "Nettoyer la toilette", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_007", "Nettoyer le bain", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_008", "Nettoyer la douche", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_009", "Rincer les parois de douche", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_010", "Ranger les produits", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_011", "Changer les serviettes", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_012", "Remplir le papier de toilette", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_013", "Vider la poubelle", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_014", "Ramasser le linge sale", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_015", "Trier le lavage", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_016", "Partir une brassée", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_017", "Mettre le linge dans la sécheuse", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_018", "Plier une brassée", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_019", "Ranger le linge propre", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_020", "Vider le filtre de la sécheuse", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_021", "Nettoyer le dessus de la laveuse", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_022", "Nettoyer le dessus de la sécheuse", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_023", "Ranger les produits de lavage", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_024", "Essuyer les tablettes", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_025", "Essuyer les interrupteurs", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_026", "Passer le balai", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_027", "Passer l'aspirateur", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_028", "Passer la vadrouille", "Salle de bain & salle de lavage"),
        referenceTask("bathroom_laundry_ref_029", "Faire un petit tri", "Salle de bain & salle de lavage")
      ]
    },
    {
      id: "bedroom",
      ...
      tasks: [
        ...
        referenceTask("bedroom_ref_003", "Ramasser le linge qui traîne", "Chambre"),
        referenceTask("bedroom_ref_004", "Mettre le linge sale au panier", "Chambre"),
        referenceTask("bedroom_ref_005", "Ranger les vêtements propres", "Chambre"),
        referenceTask("bedroom_ref_006", "Ranger la table de chevet", "Chambre"),
        referenceTask("bedroom_ref_007", "Ranger le dessus de la commode", "Chambre"),
        referenceTask("bedroom_ref_008", "Épousseter les meubles", "Chambre"),
        referenceTask("bedroom_ref_009", "Nettoyer le miroir", "Chambre"),
        referenceTask("bedroom_ref_010", "Changer les draps", "Chambre"),
        referenceTask("bedroom_ref_011", "Changer les taies d'oreiller", "Chambre"),
        referenceTask("bedroom_ref_012", "Vider la poubelle", "Chambre"),
        referenceTask("bedroom_ref_013", "Essuyer les interrupteurs", "Chambre"),
        referenceTask("bedroom_ref_014", "Passer l'aspirateur", "Chambre"),
        referenceTask("bedroom_ref_015", "Passer le balai", "Chambre"),
        referenceTask("bedroom_ref_016", "Passer la vadrouille", "Chambre"),
        referenceTask("bedroom_ref_017", "Ranger une petite section", "Chambre"),
        referenceTask("bedroom_ref_018", "Faire un petit tri de vêtements", "Chambre")
      ]
    }
  ];

  const referenceWeeklyZones = [
    { id: "entry-balcony", name: "Entrée & balcon", description: "On allège les arrivées, les départs et le coin extérieur.", color: "#dce9df" },
    { id: "kitchen-dining", name: "Cuisine & salle à manger", description: "On redonne un peu d'air aux repas et aux surfaces les plus utilisées.", color: "#f3e2cf" },
    { id: "living", name: "Salon", description: "On apaise la pièce où la vie se rassemble.", color: "#eee4d4" },
